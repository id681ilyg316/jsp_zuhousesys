...
<%@ page import="com.li.dao.impl.HouseDaoImpl" %>
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row layui-col-space15">
                ...
                <div class="layui-col-md12">
                    <div class="layui-housed">
                        <div class="layui-housed-header">数据统计</div>
                        <div class="layui-housed-body ">
                            <ul class="layui-row layui-col-space10 layui-this x-admin-houseousel x-admin-backlog">
                                ...
                                <li class="layui-col-md2 layui-col-xs6">
                                    <a href="javascript:;" class="x-admin-backlog-body">
                                        ...
                                        <p>
                                            <cite>
                                                <%
                                                    out.print(new HouseDaoImpl().totalHouse());
                                                %>
                ...
                <div class="layui-col-md12">
                    <div class="layui-housed">
                        <div class="layui-housed-header">开发团队</div>
                        <div class="layui-housed-body ">
